...
async function connectDatabase() {
    try {
        ...
        // ==========================================
        // ✅ KEEP-ALIVE PING - Prevents MongoDB from sleeping
        // ==========================================
        setInterval(async () => {
            try {
                ...
                console.error('❌ MongoDB keep-alive ping failed:', pingError.message);
                // Attempt reconnect
                try {
                    ...
                    console.error('❌ MongoDB reconnect failed:', reconnectError.message);
                }
            }
